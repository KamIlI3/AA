...
public class bankManagement { // zawiera wszystkie metody aplikacji
    ...
    createAccount(String name,
                  int passCode) // funkcja tworzenia owego konta
    {
        try {
            // warunek
    ...
    public static boolean
    loginAccount(String name, int passCode) // logowanie
    {
        try {
            // warunek
            if (name == "" || passCode == NULL) {
            ...
            if (rs.next()) {
                // menu wyboru dostepne po zalogowaniu
    ...
    public static void
    getBalance(int acNo) // sprawdzanie stanu konta
    {
        try {
    ...
    public static boolean transferMoney(int sender_ac,
                                        int reveiver_ac,
                                        int amount)
            throws SQLException // transfer pieniedzy
    {
        // warunek
